                ...
                while(virtualTcpData!=null && currentStream.CountBytesToRead() > 0) {
                    ...
                    if(this.FileStreamAssemblerList.ContainsAssembler(networkTcpSession.Flow.FiveTuple, transferIsClientToServer, true)) {
                        ...
                        if (assembler.FileStreamType == FileTransfer.FileStreamTypes.HttpGetChunked ||
                            ...
                            assembler.FileSegmentRemainingBytes < virtualTcpData.ByteCount &&
                            (assembler.FileStreamType == FileTransfer.FileStreamTypes.HttpGetNormal || assembler.FileStreamType == FileTransfer.FileStreamTypes.LPD || assembler.FileStreamType == FileTransfer.FileStreamTypes.Meterpreter)) {//I would love to add some more FileStreamTypes here! In fact, is there any transfer type that shouldn't be doing this?
                            //the final part of the file is a subset of the provided data
